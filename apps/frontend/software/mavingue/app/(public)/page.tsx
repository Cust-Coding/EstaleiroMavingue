'use client'
import CatalogoProdutos from '@/components/Home/CatalogoProdutos';
import HeroPg from '@/components/Home/HeroPg';
...
{/* navbar */}
      <nav className="sticky top-0 z-50 bg-gray-200/90 backdrop-blur-[0px]   px-6 py-4" style={{backdropFilter:"blur(0px)"}}>
